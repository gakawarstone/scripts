...
label day_1:
    ...
    lis "интересно очень интересно я так понимаю мы все не то чтобы планировали здесь оказаться"
    ...
    aml "Здесь"
    th "Оу перекличка как интересно... Могли бы ченить поинтерестнее придумать"
